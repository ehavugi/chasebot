...
#
# Generated by export_simulation on Thu Nov 21 17:34:40 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './divider32.sh' script.

./divider32.sh -reset_run
...
./divider32.sh -noclean_files

For more information on the script, please type './divider32.sh -help'.
