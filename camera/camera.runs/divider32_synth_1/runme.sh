...
HD_PWD='C:/Users/Owner/OneDrive/pic/Documents/GitHub/chasebot/camera/camera.runs/divider32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log divider32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source divider32.tcl
