...
HD_PWD='C:/Users/Owner/OneDrive/pic/Documents/GitHub/chasebot/camera/camera.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log track_init_control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source track_init_control.tcl -notrace
