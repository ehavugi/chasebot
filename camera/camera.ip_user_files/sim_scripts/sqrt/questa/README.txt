...
#
# Generated by export_simulation on Mon Nov 25 23:11:58 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './sqrt.sh' script.
...
./sqrt.sh -noclean_files

For more information on the script, please type './sqrt.sh -help'.
